...
int main() {
	...
	cout << "Second rule: \n";
	int K = rand() % (realLength - 1) + 1;
	int secondPart = realLength - K;
	invert(mystring, K, 0);
	invert(mystring, secondPart, K);
	cout << "Moving symbols (K = " << K << "):\n";
	cout << invert(mystring, realLength, 0) << endl;
	}
