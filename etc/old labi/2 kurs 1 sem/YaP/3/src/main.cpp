...
int main() {
	...
	std::cout << "\nПерегрузка операции [] для списка:" << endl;
	EA[2];
	EA[1];
	std::cout << "\nПерегрузка операции сравнения (==) и приравнивания (=): \nДо приравнивания:" << endl;
	std::cout << (TError1 == TError2) << std::endl;
	TError1 = TError2;
	std::cout << "После приравнивания:" << endl;
	std::cout << (TError1 == TError2) << std::endl;
	std::cout << "Перегрузка неравенства (!=):" << endl;
